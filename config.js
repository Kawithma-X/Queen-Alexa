...
module.exports = {
    ...
    SESSION: process.env.QUEEN_NEUTRO_SESSION === undefined ? '' : process.env.QUEEN_NEUTRO_SESSION,
    ...
    QUEEN-ALEXA: process.env.QUEEN-ALEXA === undefined ? 'Queen Alexa' : process.env.QUEEN-ALEXA,
    KTB: process.env.TAG_HEADER === undefined ? 'Queen-Alexa' : process.env.TAG_HEADER,
    ...
    DECODE: process.env.DECODE === undefined ?'EN-CUZIER-VIP-API' : process.env.DECODE,
